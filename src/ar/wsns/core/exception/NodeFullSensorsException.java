...
package ar.wsns.core.exception;

/**
 * @author Manuel Argüelles
 */
public class NodeFullSensorsException extends Exception {

    public NodeFullSensorsException(String msg) {
        super(msg);
    }

    public NodeFullSensorsException() {
        super();
    }
